    ...
    <form:form class="form-horizontal" method="post" modelAttribute="employeeForm" action="${employeeActionUrl}">
        ...
        <spring:bind path="biography">
            <div class="form-group ${status.error ? 'has-error' : ''}">
                ...
                <div class="col-sm-10">
                    <form:textarea path="biography" rows="5" class="form-control" id="biography" placeholder="biography" />
                </div>
            </div>
        </spring:bind>
        ...
        <%--<spring:bind path="content">--%>
            ...
            <%--<div class="col-sm-10">--%>
                    <%--&lt;%&ndash; <form:input path="content" type="file" name="file" id="file" class="form-control" placeholder="Photo" />&ndash;%&gt;--%>
